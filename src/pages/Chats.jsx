...
export default function Chats() {
  ...
  return (
    <div style={{ padding:32, maxWidth:900, animation:"fadeIn .3s ease" }}>
      ...
      {chats.length===0 ? <EmptyState icon="💬" title="No chats yet" subtitle="Customer bot conversations will show up here" /> : chats.map((chat,i)=>(
        <div key={i} style={{ background:t.cardBg, borderRadius:18, border:`1px solid ${t.border}`, boxShadow:t.cardShadow, padding:22, marginBottom:16 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
            <div style={{ display:"flex" }}>
              <div style={{ background:t.cardBg2, border:`1px solid ${t.border}`, borderRadius:"18px 18px 18px 4px", padding:"12px 16px", maxWidth:"65%" }}>
            ...
            <div style={{ display:"flex", justifyContent:"flex-end" }}>
              <div style={{ background:"linear-gradient(135deg,#667eea,#764ba2)", borderRadius:"18px 18px 4px 18px", padding:"12px 16px", maxWidth:"65%" }}>
